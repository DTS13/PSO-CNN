...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
BatchD11 = batchNormalizationLayer('Name','BatchD11');
BatchD12 = batchNormalizationLayer('Name','BatchD12');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
BatchD21 = batchNormalizationLayer('Name','BatchD21');
BatchD22 = batchNormalizationLayer('Name','BatchD22');
...
netM0 = addLayers(netM0,BatchD11);
netM0 = addLayers(netM0,BatchD12);
netM0 = addLayers(netM0,BatchD21);
netM0 = addLayers(netM0,BatchD22);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool1','BatchD11');
netM0 = connectLayers(netM0,'Add2','BatchD12');
netM0 = connectLayers(netM0,'BatchD11','AddD1/in1');
netM0 = connectLayers(netM0,'BatchD12','AddD1/in2');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool2','BatchD21');
netM0 = connectLayers(netM0,'Add4','BatchD22');
netM0 = connectLayers(netM0,'BatchD21','AddD2/in1');
netM0 = connectLayers(netM0,'BatchD22','AddD2/in2');
