%%%%%%%%%%%%%%%%%%%%%%%%%% Proposed FrameWork %%%%%%%%%%%%%%%%%%%%%%%%%%
%%%  CNN KDEF Pool Random Region Haar Coefficients (LH, HL & HH)  %%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Pool4 = maxPooling2dLayer([2 2],'Stride',[2 2],'Name','Pool4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ShiftV1D4 = ShiftLayerV('ShiftV1D4'); 
Odd1D4 = maxPooling2dLayer([1 1],'Stride',[1 2],'Name','Odd1D4'); %Odd
Even1D4 = maxPooling2dLayer([1 1],'Stride',[1 2],'Name','Even1D4'); %Even
MultP1D4 = MultLayerP('MultP1D4');
MultU1D4 = MultLayerU('MultU1D4');
Add1D4 = additionLayer(2,'Name','Add1D4');
Sub1D4 = additionLayer(2,'Name','Sub1D4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
ShiftH2D4 = ShiftLayerH('ShiftH2D4'); 
Odd2D4 = maxPooling2dLayer([1 1],'Stride',[2 1],'Name','Odd2D4'); %Odd
Even2D4 = maxPooling2dLayer([1 1],'Stride',[2 1],'Name','Even2D4'); %Even
MultP2D4 = MultLayerP('MultP2D4');
MultU2D4 = MultLayerU('MultU2D4');
Add2D4 = additionLayer(2,'Name','Add2D4');
Sub2D4 = additionLayer(2,'Name','Sub2D4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ShiftH3D4 = ShiftLayerH('ShiftH3D4'); 
Odd3D4 = maxPooling2dLayer([1 1],'Stride',[2 1],'Name','Odd3D4'); %Odd
Even3D4 = maxPooling2dLayer([1 1],'Stride',[2 1],'Name','Even3D4'); %Even
MultP3D4 = MultLayerP('MultP3D4');
MultU3D4 = MultLayerU('MultU3D4');
Add3D4 = additionLayer(2,'Name','Add3D4');
Sub3D4 = additionLayer(2,'Name','Sub3D4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
MultNA1D4 = MultHaarNormAprox('MultNA1D4');
MultND1D4 = MultHaarNormDetall('MultND1D4');
MultNA2D4 = MultHaarNormAprox('MultNA2D4');
MultND2D4 = MultHaarNormDetall('MultND2D4');
MultNA3D4 = MultHaarNormAprox('MultNA3D4');
MultND3D4 = MultHaarNormDetall('MultND3D4');
Relu11D4 = leakyReluLayer('Name','Relu11D4');
Relu12D4 = leakyReluLayer('Name','Relu12D4');
Relu21D4 = leakyReluLayer('Name','Relu21D4');
Relu22D4 = leakyReluLayer('Name','Relu22D4');
Relu31D4 = leakyReluLayer('Name','Relu31D4');
Relu32D4 = leakyReluLayer('Name','Relu32D4');
Selec4 = randRegWavpoolLayer('Selec4');
Cat4 = concatenationLayer(3,2,'Name','Cat4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% END  POOL 4 %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Drop2 = dropoutLayer(0.2,'Name','Drop2');
Conv5 = convolution2dLayer([7,7],4,'Padding',[0 0 0 0],'Name','Conv5'); % Number of Classes: 4
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% netM0 = addLayers(netM0,Pool4);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,ShiftV1D4);
netM0 = addLayers(netM0,Odd1D4);
netM0 = addLayers(netM0,Even1D4);
netM0 = addLayers(netM0,MultP1D4);
netM0 = addLayers(netM0,MultU1D4);
netM0 = addLayers(netM0,Add1D4);
netM0 = addLayers(netM0,Sub1D4);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,ShiftH2D4);
netM0 = addLayers(netM0,Odd2D4);
netM0 = addLayers(netM0,Even2D4);
netM0 = addLayers(netM0,MultP2D4);
netM0 = addLayers(netM0,MultU2D4);
netM0 = addLayers(netM0,Add2D4);
netM0 = addLayers(netM0,Sub2D4);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,ShiftH3D4);
netM0 = addLayers(netM0,Odd3D4);
netM0 = addLayers(netM0,Even3D4);
netM0 = addLayers(netM0,MultP3D4);
netM0 = addLayers(netM0,MultU3D4);
netM0 = addLayers(netM0,Add3D4);
netM0 = addLayers(netM0,Sub3D4);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,MultNA1D4);
netM0 = addLayers(netM0,MultND1D4);
netM0 = addLayers(netM0,MultNA2D4);
netM0 = addLayers(netM0,MultND2D4);
netM0 = addLayers(netM0,MultNA3D4);
netM0 = addLayers(netM0,MultND3D4);
netM0 = addLayers(netM0,Relu11D4);
netM0 = addLayers(netM0,Relu12D4);
netM0 = addLayers(netM0,Relu21D4);
netM0 = addLayers(netM0,Relu22D4);
netM0 = addLayers(netM0,Relu31D4);
netM0 = addLayers(netM0,Relu32D4);
netM0 = addLayers(netM0,Selec4);
netM0 = addLayers(netM0,Cat4);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END POOL 4
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Relu4','Odd1D4');
netM0 = connectLayers(netM0,'Relu4','ShiftV1D4');
netM0 = connectLayers(netM0,'ShiftV1D4','Even1D4');
netM0 = connectLayers(netM0,'Even1D4','MultP1D4');
netM0 = connectLayers(netM0,'Even1D4','Add1D4/in1');
netM0 = connectLayers(netM0,'Odd1D4','Sub1D4/in1');
netM0 = connectLayers(netM0,'Sub1D4','MultU1D4');
netM0 = connectLayers(netM0,'MultU1D4','Add1D4/in2');
netM0 = connectLayers(netM0,'MultP1D4','Sub1D4/in2');
netM0 = connectLayers(netM0,'Add1D4','MultNA1D4');
netM0 = connectLayers(netM0,'Sub1D4','MultND1D4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'MultNA1D4','Relu11D4');
netM0 = connectLayers(netM0,'MultND1D4','Relu12D4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Relu11D4','Odd2D4');
netM0 = connectLayers(netM0,'Relu11D4','ShiftH2D4');
netM0 = connectLayers(netM0,'ShiftH2D4','Even2D4');
netM0 = connectLayers(netM0,'Even2D4','MultP2D4');
netM0 = connectLayers(netM0,'Even2D4','Add2D4/in1');
netM0 = connectLayers(netM0,'Odd2D4','Sub2D4/in1');
netM0 = connectLayers(netM0,'Sub2D4','MultU2D4');
netM0 = connectLayers(netM0,'MultU2D4','Add2D4/in2');
netM0 = connectLayers(netM0,'MultP2D4','Sub2D4/in2');
netM0 = connectLayers(netM0,'Add2D4','MultNA2D4');
netM0 = connectLayers(netM0,'Sub2D4','MultND2D4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Relu12D4','Odd3D4');
netM0 = connectLayers(netM0,'Relu12D4','ShiftH3D4');
netM0 = connectLayers(netM0,'ShiftH3D4','Even3D4');
netM0 = connectLayers(netM0,'Even3D4','MultP3D4');
netM0 = connectLayers(netM0,'Even3D4','Add3D4/in1');
netM0 = connectLayers(netM0,'Odd3D4','Sub3D4/in1');
netM0 = connectLayers(netM0,'Sub3D4','MultU3D4');
netM0 = connectLayers(netM0,'MultU3D4','Add3D4/in2');
netM0 = connectLayers(netM0,'MultP3D4','Sub3D4/in2');
netM0 = connectLayers(netM0,'Add3D4','MultNA3D4');
netM0 = connectLayers(netM0,'Sub3D4','MultND3D4');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'MultNA2D4','Relu21D4');
netM0 = connectLayers(netM0,'MultND2D4','Relu22D4');
netM0 = connectLayers(netM0,'MultNA3D4','Relu31D4');
netM0 = connectLayers(netM0,'MultND3D4','Relu32D4');
netM0 = connectLayers(netM0,'Relu21D4','Cat4/in1');
netM0 = connectLayers(netM0,'Relu22D4','Selec4/in1');
netM0 = connectLayers(netM0,'Relu31D4','Selec4/in2');
netM0 = connectLayers(netM0,'Relu32D4','Selec4/in3');
netM0 = connectLayers(netM0,'Selec4','Cat4/in2');
netM0 = connectLayers(netM0,'Cat4','Drop2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%netM0 = connectLayers(netM0,'Relu4','Drop2');
