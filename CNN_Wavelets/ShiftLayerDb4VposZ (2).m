classdef ShiftLayerDb4VposZ < nnet.layer.Layer % & nnet.layer.Formattable (Optional) 
    ...
    methods
        function layer = ShiftLayerDb4VposZ(name)
        ...
        function [Z1] = predict(layer,X)
            ...
            sz = size(X);
            IN1=X;
            IN1(2:sz(1),1:sz(2)) = X(1:sz(1)-1,1:sz(2));
            IN1(1,1:sz(2)) = X(sz(1),1:sz(2));
            Z1=IN1;
        end        
