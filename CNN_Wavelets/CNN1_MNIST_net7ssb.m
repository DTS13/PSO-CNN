...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add2D1','tanh1D1'); % LL
netM0 = connectLayers(netM0,'tanh1D1','Batch1D1');
netM0 = connectLayers(netM0,'Batch1D1','CatD1/in1');
netM0 = connectLayers(netM0,'Sub2D1','tanh2D1'); % LH
netM0 = connectLayers(netM0,'tanh2D1','Batch2D1');
netM0 = connectLayers(netM0,'Batch2D1','CatD1/in2');
netM0 = connectLayers(netM0,'Add3D1','tanh3D1'); % HL
netM0 = connectLayers(netM0,'tanh3D1','Batch3D1');
netM0 = connectLayers(netM0,'Batch3D1','CatD1/in3');
netM0 = connectLayers(netM0,'Sub3D1','tanh4D1'); % HH
netM0 = connectLayers(netM0,'tanh4D1','Batch4D1');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add2D2','tanh1D2'); % LL
netM0 = connectLayers(netM0,'tanh1D2','Batch1D2');
netM0 = connectLayers(netM0,'Batch1D2','CatD2/in1');
netM0 = connectLayers(netM0,'Sub2D2','tanh2D2'); % LH
netM0 = connectLayers(netM0,'tanh2D2','Batch2D2');
netM0 = connectLayers(netM0,'Batch2D2','CatD2/in2');
netM0 = connectLayers(netM0,'Add3D2','tanh3D2'); % HL
netM0 = connectLayers(netM0,'tanh3D2','Batch3D2');
netM0 = connectLayers(netM0,'Batch3D2','CatD2/in3');
netM0 = connectLayers(netM0,'Sub3D2','tanh4D2'); % HH
netM0 = connectLayers(netM0,'tanh4D2','Batch4D2');
