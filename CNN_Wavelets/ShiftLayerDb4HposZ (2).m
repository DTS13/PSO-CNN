classdef ShiftLayerDb4HposZ < nnet.layer.Layer % & nnet.layer.Formattable (Optional) 
    ...
    methods
        function layer = ShiftLayerDb4HposZ(name)
        ...
        function [Z1] = predict(layer,X)
            ...
            sz = size(X);
            IN1=X;
            IN1(1:sz(1),2:sz(2)) = X(1:sz(1),1:sz(2)-1);
            IN1(1:sz(1),1) = X(1:sz(1),sz(2));
            Z1=IN1;
        end        
