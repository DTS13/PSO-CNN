...
lgraphM0(1) = imageInputLayer([5 5 1],'Name','ImageInputLayer');
lgraphM0(2) = batchNormalizationLayer('Name','Batch1');
lgraphM0(3) = convolution2dLayer([2,2],36,'Name','Conv1');
lgraphM0(4) = convolution2dLayer([2,2],36,'Name','Conv2');
lgraphM0(5) = convolution2dLayer([2,2],106,'Name','Conv3');
lgraphM0(6) = convolution2dLayer([2,2],106,'Name','Conv4');
