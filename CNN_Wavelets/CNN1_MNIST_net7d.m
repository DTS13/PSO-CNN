...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Relu1D1 = reluLayer('Name','Relu1D1');
%Relu2D1 = reluLayer('Name','Relu2D1');
%Relu3D1 = reluLayer('Name','Relu3D1');
%Relu4D1 = reluLayer('Name','Relu4D1');
Relu5D1 = reluLayer('Name','Relu5D1');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Relu1D2 = reluLayer('Name','Relu1D2');
%Relu2D2 = reluLayer('Name','Relu2D2');
%Relu3D2 = reluLayer('Name','Relu3D2');
%Relu4D2 = reluLayer('Name','Relu4D2');
Relu5D2 = reluLayer('Name','Relu5D2');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add2D1','Add1DD1/in1'); % LL
netM0 = connectLayers(netM0,'Sub2D1','Add1DD1/in2'); % LH
netM0 = connectLayers(netM0,'Add3D1','Add1DD1/in3'); % HL
netM0 = connectLayers(netM0,'Sub3D1','Add1DD1/in4'); % HH
netM0 = connectLayers(netM0,'Add1DD1','Relu5D1');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add2D2','Add1DD2/in1'); % LL
netM0 = connectLayers(netM0,'Sub2D2','Add1DD2/in2'); % LH
netM0 = connectLayers(netM0,'Add3D2','Add1DD2/in3'); % HL
netM0 = connectLayers(netM0,'Sub3D2','Add1DD2/in4'); % HH
netM0 = connectLayers(netM0,'Add1DD2','Relu5D2');
