classdef separate11Layer < nnet.layer.Layer % & nnet.layer.Formattable (Optional) 
    ...
    methods
        function layer = separate11Layer(name)
            ...
            layer.Description = "Separate elements in position (1,1) in 2x2 regions";
