%%%%%%%%%%% Proposed FrameWork %%%%%%%%%%%%%%%
%%%%%%%%%%%  CNN MNIST HAAR (LL,LH,HL,HH) Net 7rt  %%%%%%%%%%%%%%%
% TanhLayer at the end of 2 COEFF. and 4 COEFF.
% ReluLayer at Relu1 of Network
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Relu11D1 = tanhLayer('Name','Relu11D1');
Relu12D1 = tanhLayer('Name','Relu12D1');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Relu11D2 = tanhLayer('Name','Relu11D2');
Relu12D2 = tanhLayer('Name','Relu12D2');
Relu1D2 = tanhLayer('Name','Relu1D2');
Relu2D2 = tanhLayer('Name','Relu2D2');
Relu3D2 = tanhLayer('Name','Relu3D2');
Relu4D2 = tanhLayer('Name','Relu4D2');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add2D1','MultNA2D1'); % LL
netM0 = connectLayers(netM0,'MultNA2D1','Relu1D1'); % LL
netM0 = connectLayers(netM0,'Relu1D1','CatD1/in1');
netM0 = connectLayers(netM0,'Sub2D1','MultND2D1'); % LH
netM0 = connectLayers(netM0,'MultND2D1','Relu2D1'); % LH
netM0 = connectLayers(netM0,'Relu2D1','CatD1/in2');
netM0 = connectLayers(netM0,'Add3D1','MultNA3D1'); % HL
netM0 = connectLayers(netM0,'MultNA3D1','Relu3D1'); % HL
netM0 = connectLayers(netM0,'Relu3D1','CatD1/in3');
netM0 = connectLayers(netM0,'Sub3D1','MultND3D1'); % HH
netM0 = connectLayers(netM0,'MultND3D1','Relu4D1'); % HH
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add2D2','MultNA2D2'); % LL
netM0 = connectLayers(netM0,'MultNA2D2','Relu1D2'); % LL
netM0 = connectLayers(netM0,'Relu1D2','CatD2/in1');
netM0 = connectLayers(netM0,'Sub2D2','MultND2D2'); % LH
netM0 = connectLayers(netM0,'MultND2D2','Relu2D2'); % LH
netM0 = connectLayers(netM0,'Relu2D2','CatD2/in2');
netM0 = connectLayers(netM0,'Add3D2','MultNA3D2'); % HL
netM0 = connectLayers(netM0,'MultNA3D2','Relu3D2'); % HL
netM0 = connectLayers(netM0,'Relu3D2','CatD2/in3');
netM0 = connectLayers(netM0,'Sub3D2','MultND3D2'); % HH
netM0 = connectLayers(netM0,'MultND3D2','Relu4D2'); % HH
netM0 = connectLayers(netM0,'Relu4D2','CatD2/in4');
netM0 = connectLayers(netM0,'CatD2','Batch3');
