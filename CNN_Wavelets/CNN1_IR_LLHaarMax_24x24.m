...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In = imageInputLayer([24 24 1],'Name','In');
Batch1 = batchNormalizationLayer('Name','Batch1');   %Conv1a = convolution2dLayer([5,5],20,'Name','Conv1a');
Conv1 = convolution2dLayer([1,1],20,'Name','Conv1'); %Conv1 = convolution2dLayer([1,1],20,'Name','Conv1');
Batch2 = batchNormalizationLayer('Name','Batch2');
Pool1 = maxPooling2dLayer([2,2],'Stride',[2 2],'Name','Pool1');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ShiftV1 = ShiftLayerV('ShiftV1'); 
Odd1 = maxPooling2dLayer([1 1],'Stride',[2 1],'Name','Odd1'); %Odd
Even1 = maxPooling2dLayer([1 1],'Stride',[2 1],'Name','Even1'); %Even
...
Odd2 = maxPooling2dLayer([1 1],'Stride',[1 2],'Name','Odd2'); %Odd
Even2 = maxPooling2dLayer([1 1],'Stride',[1 2],'Name','Even2'); %Even
...
Odd3 = maxPooling2dLayer([1 1],'Stride',[2 1],'Name','Odd3'); %Odd
Even3 = maxPooling2dLayer([1 1],'Stride',[2 1],'Name','Even3'); %Even
...
Odd4 = maxPooling2dLayer([1 1],'Stride',[1 2],'Name','Odd4'); %Odd
Even4 = maxPooling2dLayer([1 1],'Stride',[1 2],'Name','Even4'); %Even
...
FC1 = fullyConnectedLayer(4,'Name','FC1');   %4 number of classes
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool1','Cat1/in1');
netM0 = connectLayers(netM0,'Add2','Cat1/in2');
netM0 = connectLayers(netM0,'Cat1','ReluD1');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool2','Cat2/in1');
netM0 = connectLayers(netM0,'Add4','Cat2/in2');
netM0 = connectLayers(netM0,'Cat2','ReluD2');
netM0 = connectLayers(netM0,'ReluD2','Batch3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
