...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Add1D = additionLayer(3,'Name','Add1D');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Add2D = additionLayer(3,'Name','Add2D');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool1m','Add1D/in1');
netM0 = connectLayers(netM0,'Pool1a','Add1D/in2');
netM0 = connectLayers(netM0,'Add2','Add1D/in3');
netM0 = connectLayers(netM0,'Add1D','ReluD1');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool2m','Add2D/in1');
netM0 = connectLayers(netM0,'Pool2a','Add2D/in2');
netM0 = connectLayers(netM0,'Add4','Add2D/in3');
netM0 = connectLayers(netM0,'Add2D','ReluD2');
