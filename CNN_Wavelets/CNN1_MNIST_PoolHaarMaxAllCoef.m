%%%%%%%%%%%%%%%%%%%% Proposed FrameWork %%%%%%%%%%%%%%%%%%%%%
%%%%  CNN MNIST Pool Max & Haar All Coefficients net G %%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Cat1 = concatenationLayer(3,5,'Name','Cat1');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Cat2 = concatenationLayer(3,5,'Name','Cat2');
...
netM0 = connectLayers(netM0,'Relu21D1','Cat1/in2');
netM0 = connectLayers(netM0,'Relu22D1','Cat1/in3');
netM0 = connectLayers(netM0,'Relu31D1','Cat1/in4');
netM0 = connectLayers(netM0,'Relu32D1','Cat1/in5');
...
netM0 = connectLayers(netM0,'Relu21D2','Cat2/in2');
netM0 = connectLayers(netM0,'Relu22D2','Cat2/in3');
netM0 = connectLayers(netM0,'Relu31D2','Cat2/in4');
netM0 = connectLayers(netM0,'Relu32D2','Cat2/in5');
