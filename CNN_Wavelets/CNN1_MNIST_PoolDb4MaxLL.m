%%%%%%%%%%%%%%%%%%% Proposed FrameWork %%%%%%%%%%%%%
%%%  CNN MNIST Pool Db4 All Coefficients Net E %%%%%
...
CatD1 = concatenationLayer(3,2,'Name','CatD1');
...
CatD2 = concatenationLayer(3,2,'Name','CatD2');
...
netM0 = connectLayers(netM0,'Pool1','CatD1/in2');
...
netM0 = connectLayers(netM0,'Pool2','CatD2/in2');
