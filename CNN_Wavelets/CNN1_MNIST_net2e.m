...
BatchD1 = batchNormalizationLayer('Name','BatchD1');
...
%BatchD2 = batchNormalizationLayer('Name','BatchD2');
...
netM0 = addLayers(netM0,BatchD1);
%netM0 = addLayers(netM0,BatchD2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
netM0 = connectLayers(netM0,'Cat1','BatchD1');
netM0 = connectLayers(netM0,'BatchD1','Conv2');
