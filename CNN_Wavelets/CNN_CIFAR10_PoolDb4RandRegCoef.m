...
MultPA1D3 = MultLayerDb4P1('MultPA1D3');
MultUA1D3 = MultLayerDb4U11('MultUA1D3');
MultUB1D3 = MultLayerDb4U12('MultUB1D3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ShiftVnZ1D3 = ShiftLayerDb4VnegZ('ShiftVnZ1D3');
ShiftVpZ1D3 = ShiftLayerDb4VposZ('ShiftVpZ1D3');
ShiftHnZ2D3 = ShiftLayerDb4HnegZ('ShiftHnZ2D3');
ShiftHpZ2D3 = ShiftLayerDb4HposZ('ShiftHpZ2D3');
ShiftHnZ3D3 = ShiftLayerDb4HnegZ('ShiftHnZ3D3');
ShiftHpZ3D3 = ShiftLayerDb4HposZ('ShiftHpZ3D3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Add1aD3 = additionLayer(2,'Name','Add1aD3');
Add1bD3 = additionLayer(2,'Name','Add1bD3');
MultNA1D3 = MultDb4NormAprox('MultNA1D3');
Sub1aD3 = additionLayer(2,'Name','Sub1aD3');
Sub1bD3 = additionLayer(2,'Name','Sub1bD3');
MultND1D3 = MultDb4NormDetail('MultND1D3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
MultPA2D3 = MultLayerDb4P1('MultPA2D3');
MultUA2D3 = MultLayerDb4U11('MultUA2D3');
MultUB2D3 = MultLayerDb4U12('MultUB2D3');
Add2aD3 = additionLayer(2,'Name','Add2aD3');
Add2bD3 = additionLayer(2,'Name','Add2bD3');
MultNA2D3 = MultDb4NormAprox('MultNA2D3');
Sub2aD3 = additionLayer(2,'Name','Sub2aD3');
Sub2bD3 = additionLayer(2,'Name','Sub2bD3');
MultND2D3 = MultDb4NormDetail('MultND2D3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
MultPA3D3 = MultLayerDb4P1('MultPA3D3');
MultUA3D3 = MultLayerDb4U11('MultUA3D3');
MultUB3D3 = MultLayerDb4U12('MultUB3D3');
Add3aD3 = additionLayer(2,'Name','Add3aD3');
Add3bD3 = additionLayer(2,'Name','Add3bD3');
MultNA3D3 = MultDb4NormAprox('MultNA3D3');
Sub3aD3 = additionLayer(2,'Name','Sub3aD3');
Sub3bD3 = additionLayer(2,'Name','Sub3bD3');
MultND3D3 = MultDb4NormDetail('MultND3D3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% POOL 3 Declared into the Net
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,ShiftVnZ1D3);
netM0 = addLayers(netM0,ShiftVpZ1D3);
netM0 = addLayers(netM0,ShiftHnZ2D3);
netM0 = addLayers(netM0,ShiftHpZ2D3);
netM0 = addLayers(netM0,ShiftHnZ3D3);
netM0 = addLayers(netM0,ShiftHpZ3D3);
netM0 = addLayers(netM0,ShiftV1D3);
netM0 = addLayers(netM0,Odd1D3);
netM0 = addLayers(netM0,Even1D3);
netM0 = addLayers(netM0,MultPA1D3);
netM0 = addLayers(netM0,MultUA1D3);
netM0 = addLayers(netM0,MultUB1D3);
netM0 = addLayers(netM0,Add1aD3);
netM0 = addLayers(netM0,Add1bD3);
netM0 = addLayers(netM0,MultNA1D3);
netM0 = addLayers(netM0,Sub1aD3);
netM0 = addLayers(netM0,Sub1bD3);
netM0 = addLayers(netM0,MultND1D3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,ShiftH2D3);
netM0 = addLayers(netM0,Odd2D3);
netM0 = addLayers(netM0,Even2D3);
netM0 = addLayers(netM0,MultPA2D3);
netM0 = addLayers(netM0,MultUA2D3);
netM0 = addLayers(netM0,MultUB2D3);
netM0 = addLayers(netM0,Add2aD3);
netM0 = addLayers(netM0,Add2bD3);
netM0 = addLayers(netM0,MultNA2D3);
netM0 = addLayers(netM0,Sub2aD3);
netM0 = addLayers(netM0,Sub2bD3);
netM0 = addLayers(netM0,MultND2D3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,ShiftH3D3);
netM0 = addLayers(netM0,Odd3D3);
netM0 = addLayers(netM0,Even3D3);
netM0 = addLayers(netM0,MultPA3D3);
netM0 = addLayers(netM0,MultUA3D3);
netM0 = addLayers(netM0,MultUB3D3);
netM0 = addLayers(netM0,Add3aD3);
netM0 = addLayers(netM0,Add3bD3);
netM0 = addLayers(netM0,MultNA3D3);
netM0 = addLayers(netM0,Sub3aD3);
netM0 = addLayers(netM0,Sub3bD3);
...
% POOL 1 Connections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Relu1','Odd1D1');           % Odd11
...
% POOL 2 Connections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Relu2','Odd1D2');            % Odd12
...
% POOL 3 Connections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Relu3','Odd1D3');            % Odd12
netM0 = connectLayers(netM0,'Relu3','ShiftV1D3');
netM0 = connectLayers(netM0,'ShiftV1D3','Even1D3');       % Even12
netM0 = connectLayers(netM0,'Even1D3','MultPA1D3');       % P1*E12
netM0 = connectLayers(netM0,'Even1D3','Add1aD3/in1');     % s1 = E12 + _
netM0 = connectLayers(netM0,'Odd1D3','Sub1aD3/in1');      % d1 = O12 + _
netM0 = connectLayers(netM0,'Sub1aD3','MultUA1D3');       % U11*d1
netM0 = connectLayers(netM0,'MultUA1D3','Add1aD3/in2');   % s1 = E12 + U11*d1
netM0 = connectLayers(netM0,'MultPA1D3','Sub1aD3/in2');   % d1 = O12 + P1*E12
netM0 = connectLayers(netM0,'Sub1aD3','ShiftVnZ1D3');     % d11 = d1*Z^(-1)
netM0 = connectLayers(netM0,'ShiftVnZ1D3','MultUB1D3');   % U12*d11
netM0 = connectLayers(netM0,'MultUB1D3','Add1bD3/in1');   % s2 = _ + U12*d11
netM0 = connectLayers(netM0,'Add1aD3','Add1bD3/in2');     % s2 = s1 + U12*d11
netM0 = connectLayers(netM0,'Add1bD3','ShiftVpZ1D3');     % s22 = s2*Z^(+1)
netM0 = connectLayers(netM0,'ShiftVpZ1D3','Sub1bD3/in1'); % d2 = __ + s22
netM0 = connectLayers(netM0,'Sub1aD3','Sub1bD3/in2');     % d2 = d1 + s22
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add1bD3','MultNA1D3');       % NormAprox 11 * s2
netM0 = connectLayers(netM0,'MultNA1D3','Relu11D3');      % Odd22
netM0 = connectLayers(netM0,'MultND1D3','Relu12D3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Relu11D3','Odd2D3');         % Odd22
netM0 = connectLayers(netM0,'Relu11D3','ShiftH2D3');
netM0 = connectLayers(netM0,'ShiftH2D3','Even2D3');       % Even22
netM0 = connectLayers(netM0,'Even2D3','MultPA2D3');       % P1*E22
netM0 = connectLayers(netM0,'Even2D3','Add2aD3/in1');     % s1 = E22 + _
netM0 = connectLayers(netM0,'Odd2D3','Sub2aD3/in1');      % d1 = O22 + _
netM0 = connectLayers(netM0,'Sub2aD3','MultUA2D3');       % U11*d1
netM0 = connectLayers(netM0,'MultUA2D3','Add2aD3/in2');   % s1 = E22 + U11*d1
netM0 = connectLayers(netM0,'MultPA2D3','Sub2aD3/in2');   % d1 = O22 + P1*E22
netM0 = connectLayers(netM0,'Sub2aD3','ShiftHnZ2D3');     % d11 = d1*Z^(-1)
netM0 = connectLayers(netM0,'ShiftHnZ2D3','MultUB2D3');   % U12*d11
netM0 = connectLayers(netM0,'MultUB2D3','Add2bD3/in1');   % s2 = _ + U12*d11
netM0 = connectLayers(netM0,'Add2aD3','Add2bD3/in2');     % s2 = s1 + U12*d11
netM0 = connectLayers(netM0,'Add2bD3','ShiftHpZ2D3');     % s22 = s2*Z^(+1)
netM0 = connectLayers(netM0,'ShiftHpZ2D3','Sub2bD3/in1'); % d2 = __ + s22
netM0 = connectLayers(netM0,'Sub2aD3','Sub2bD3/in2');     % d2 = d1 + s22
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Sub1bD3','MultND1D3');        % NormDetail 12 * d2
netM0 = connectLayers(netM0,'Relu12D3','Odd3D3');         % Odd32
netM0 = connectLayers(netM0,'Relu12D3','ShiftH3D3');
netM0 = connectLayers(netM0,'ShiftH3D3','Even3D3');        % Even32
netM0 = connectLayers(netM0,'Even3D3','MultPA3D3');        % P1*E32
netM0 = connectLayers(netM0,'Even3D3','Add3aD3/in1');      % s1 = E32 + _
netM0 = connectLayers(netM0,'Odd3D3','Sub3aD3/in1');       % d1 = O32 + _
netM0 = connectLayers(netM0,'Sub3aD3','MultUA3D3');        % U11*d1
netM0 = connectLayers(netM0,'MultUA3D3','Add3aD3/in2');    % s1 = E32 + U11*d1
netM0 = connectLayers(netM0,'MultPA3D3','Sub3aD3/in2');    % d1 = O32 + P1*E32
netM0 = connectLayers(netM0,'Sub3aD3','ShiftHnZ3D3');      % d11 = d1*Z^(-1)
netM0 = connectLayers(netM0,'ShiftHnZ3D3','MultUB3D3');    % U12*d11
netM0 = connectLayers(netM0,'MultUB3D3','Add3bD3/in1');   % s2 = _ + U12*d11
netM0 = connectLayers(netM0,'Add3aD3','Add3bD3/in2');     % s2 = s1 + U12*d11
netM0 = connectLayers(netM0,'Add3bD3','ShiftHpZ3D3');     % s22 = s2*Z^(+1)
netM0 = connectLayers(netM0,'ShiftHpZ3D3','Sub3bD3/in1'); % d2 = __ + s22
netM0 = connectLayers(netM0,'Sub3aD3','Sub3bD3/in2');     % d2 = d1 + s22
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add2bD3','MultNA2D3');       % NormAprox 22 * s2
netM0 = connectLayers(netM0,'MultNA2D3','Relu21D3'); % LL
netM0 = connectLayers(netM0,'Relu21D3','Cat3/in1');
netM0 = connectLayers(netM0,'Sub2bD3','MultND2D3');       % NormDetail 22 * d2
netM0 = connectLayers(netM0,'MultND2D3','Relu22D3'); % LH
netM0 = connectLayers(netM0,'Relu22D3','Selec3/in1');
netM0 = connectLayers(netM0,'Add3bD3','MultNA3D3');       % NormAprox 32 * s2
netM0 = connectLayers(netM0,'MultNA3D3','Relu31D3'); % HL
netM0 = connectLayers(netM0,'Relu31D3','Selec3/in2');
netM0 = connectLayers(netM0,'Sub3bD3','MultND3D3');       % NormDetail 32 * d2
netM0 = connectLayers(netM0,'MultND3D3','Relu32D3'); % HH
