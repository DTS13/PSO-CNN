...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%netM0 = connectLayers(netM0,'Conv2','Pool1D2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
netM0 = connectLayers(netM0,'Add1CD1','Cat1/in1');
netM0 = connectLayers(netM0,'Add2CD1','Cat1/in2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
netM0 = connectLayers(netM0,'Add1CD2','Cat2/in1');
netM0 = connectLayers(netM0,'Add2CD2','Cat2/in2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'LLD1','Add1CD1/in1'); % LL Aprox.
netM0 = connectLayers(netM0,'HLD1','Add2CD1/in1'); % HL Horiz.
netM0 = connectLayers(netM0,'LHD1','Add1CD1/in2'); % LH Vert.
netM0 = connectLayers(netM0,'HHD1','Add2CD1/in2'); % HH Diag.
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'LLD2','Add1CD2/in1'); % LL Aprox.
netM0 = connectLayers(netM0,'HLD2','Add2CD2/in1'); % HL Horiz.
netM0 = connectLayers(netM0,'LHD2','Add1CD2/in2'); % LH Vert.
netM0 = connectLayers(netM0,'HHD2','Add2CD2/in2'); % HH Diag.
%%%%%%%%%%%%%%%%%%%%%%%%%%%
