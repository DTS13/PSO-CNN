%%%%%%%%%%% Proposed FrameWork %%%%%%%%%%%%%%%
%%%%%%%%%%%  CNN MNIST HAAR (LL,LH,HL,HH) Net 7rr  %%%%%%%%%%%%%%%
% LeakyRELU LAYER at the end of 4 COEFF.
% LeakyRELU LAYER at the end of CAT.
...
netM0 = connectLayers(netM0,'MultNA1D1','Odd2D1');
...
netM0 = connectLayers(netM0,'MultND1D1','Odd3D1');
...
netM0 = connectLayers(netM0,'MultNA1D2','Odd2D2');
...
netM0 = connectLayers(netM0,'MultND1D2','Odd3D2');
...
netM0 = connectLayers(netM0,'Relu5D2','Batch2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
