classdef separate12Layer < nnet.layer.Layer % & nnet.layer.Formattable (Optional) 
    ...
    methods
        function layer = separate12Layer(name)
            ...
            layer.Description = "Separate elements in position (1,2) in 2x2 regions";
