classdef separate21Layer < nnet.layer.Layer % & nnet.layer.Formattable (Optional) 
    ...
    methods
        function layer = separate21Layer(name)
            ...
            layer.Description = "Separate elements in position (2,1) in 2x2 regions";
