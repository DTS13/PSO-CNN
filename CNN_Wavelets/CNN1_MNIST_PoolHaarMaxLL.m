%%%%%%%%%%%%%%%%%%%%% Proposed FrameWork %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%  CNN MNIST Pool Max & Haar LL Net F %%%%%%%%%%%%
...
netM0 = connectLayers(netM0,'Batch1','Pool1');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Batch1','Odd1');
netM0 = connectLayers(netM0,'Batch1','ShiftV1');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add1','MultNA1D1');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'MultNA1D1','Odd2');
netM0 = connectLayers(netM0,'MultNA1D1','ShiftH2');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add2','MultNA2D1');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool1','Cat1/in1');
netM0 = connectLayers(netM0,'MultNA2D1','Cat1/in2');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add3','MultNA1D2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'MultNA1D2','Odd4');
netM0 = connectLayers(netM0,'MultNA1D2','ShiftH4');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Add4','MultNA2D2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool2','Cat2/in1');
netM0 = connectLayers(netM0,'MultNA2D2','Cat2/in2');
