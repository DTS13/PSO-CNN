...
Relu1 = leakyReluLayer('Name','Relu1');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PoolmD1 = maxPooling2dLayer([2 2],'Stride',[2 2],'Name','PoolmD1');
PoolaD1 = averagePooling2dLayer([2 2],'Stride',[2 2],'Name','PoolaD1');
PoolxD1 = mixpoolLayer('PoolxD1');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Conv2 = convolution2dLayer([5,5],32,'Padding',[2 2 2 2],'Name','Conv2');
Batch3 = batchNormalizationLayer('Name','Batch3');
Relu2 = leakyReluLayer('Name','Relu2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PoolmD2 = maxPooling2dLayer([2 2],'Stride',[2 2],'Name','PoolmD2');
PoolaD2 = averagePooling2dLayer([2 2],'Stride',[2 2],'Name','PoolaD2');
PoolxD2 = mixpoolLayer('PoolxD2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Conv3 = convolution2dLayer([5,5],32,'Padding',[2 2 2 2],'Name','Conv3');
Batch4 = batchNormalizationLayer('Name','Batch4');
Relu3 = leakyReluLayer('Name','Relu3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PoolmD3 = maxPooling2dLayer([2 2],'Stride',[2 2],'Name','PoolmD3');
PoolaD3 = averagePooling2dLayer([2 2],'Stride',[2 2],'Name','PoolaD3');
PoolxD3 = mixpoolLayer('PoolxD3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Drop1 = dropoutLayer(0.1,'Name','Drop1');
Conv4 = convolution2dLayer([4,4],64,'Name','Conv4');
Relu4 = leakyReluLayer('Name','Relu4');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,PoolmD1);
netM0 = addLayers(netM0,PoolaD1);
netM0 = addLayers(netM0,PoolxD1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,Conv2);
netM0 = addLayers(netM0,Batch3);
netM0 = addLayers(netM0,Relu2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,PoolmD2);
netM0 = addLayers(netM0,PoolaD2);
netM0 = addLayers(netM0,PoolxD2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,Conv3);
netM0 = addLayers(netM0,Batch4);
netM0 = addLayers(netM0,Relu3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,PoolmD3);
netM0 = addLayers(netM0,PoolaD3);
netM0 = addLayers(netM0,PoolxD3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
netM0 = connectLayers(netM0,'Relu1','PoolmD1');
netM0 = connectLayers(netM0,'Relu1','PoolaD1');
netM0 = connectLayers(netM0,'PoolmD1','PoolxD1/in1');
netM0 = connectLayers(netM0,'PoolaD1','PoolxD1/in2');
netM0 = connectLayers(netM0,'PoolxD1','Conv2');
netM0 = connectLayers(netM0,'Conv2','Batch3');
netM0 = connectLayers(netM0,'Batch3','Relu2');
netM0 = connectLayers(netM0,'Relu2','PoolmD2');
netM0 = connectLayers(netM0,'Relu2','PoolaD2');
netM0 = connectLayers(netM0,'PoolmD2','PoolxD2/in1');
netM0 = connectLayers(netM0,'PoolaD2','PoolxD2/in2');
netM0 = connectLayers(netM0,'PoolxD2','Conv3');
netM0 = connectLayers(netM0,'Conv3','Batch4');
netM0 = connectLayers(netM0,'Batch4','Relu3');
netM0 = connectLayers(netM0,'Relu3','PoolmD3');
netM0 = connectLayers(netM0,'Relu3','PoolaD3');
netM0 = connectLayers(netM0,'PoolmD3','PoolxD3/in1');
netM0 = connectLayers(netM0,'PoolaD3','PoolxD3/in2');
netM0 = connectLayers(netM0,'PoolxD3','Drop1');
