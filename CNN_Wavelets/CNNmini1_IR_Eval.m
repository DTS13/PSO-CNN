...
%actvn1 = activations(M0mnist,im,'Batch2');
%actvn2 = activations(M0mnist,im,'Add2');
%actvn3 = activations(M0mnist,im,'Sub2');
%actvn4 = activations(M0mnist,im,'Batch4c');
%5actvn5 = activations(M0mnist,im,'Batch3D1');
...
%figure(10); montage(rescale(actvn4))
