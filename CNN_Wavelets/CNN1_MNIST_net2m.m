...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ReluD11 = reluLayer('Name','ReluD11');
ReluD12 = reluLayer('Name','ReluD12');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ReluD21 = reluLayer('Name','ReluD21');
ReluD22 = reluLayer('Name','ReluD22');
...
netM0 = connectLayers(netM0,'ReluD11','Cat1/in1');
netM0 = connectLayers(netM0,'ReluD12','Cat1/in2');
...
netM0 = connectLayers(netM0,'ReluD21','Cat2/in1');
netM0 = connectLayers(netM0,'ReluD22','Cat2/in2');
