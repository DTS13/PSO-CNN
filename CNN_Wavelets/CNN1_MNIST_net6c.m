...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool1m','Cat1/in1');
netM0 = connectLayers(netM0,'Pool1a','Cat1/in2');
netM0 = connectLayers(netM0,'Add2','Cat1/in3');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Pool2m','Cat2/in1');
netM0 = connectLayers(netM0,'Pool2a','Cat2/in2');
netM0 = connectLayers(netM0,'Add4','Cat2/in3');
