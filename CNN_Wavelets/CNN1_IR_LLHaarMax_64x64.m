...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In = imageInputLayer([64 64 1],'Name','In');
...
Odd1 = maxPooling2dLayer([1 2],'Stride',[1 2],'Name','Odd1'); %Odd
Even1 = maxPooling2dLayer([1 2],'Stride',[1 2],'Name','Even1'); %Even
...
Odd2 = maxPooling2dLayer([2 1],'Stride',[2 1],'Name','Odd2'); %Odd
Even2 = maxPooling2dLayer([2 1],'Stride',[2 1],'Name','Even2'); %Even
...
Odd3 = maxPooling2dLayer([1 2],'Stride',[1 2],'Name','Odd3'); %Odd
Even3 = maxPooling2dLayer([1 2],'Stride',[1 2],'Name','Even3'); %Even
...
Odd4 = maxPooling2dLayer([2 1],'Stride',[2 1],'Name','Odd4'); %Odd
Even4 = maxPooling2dLayer([2 1],'Stride',[2 1],'Name','Even4'); %Even
