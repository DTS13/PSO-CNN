...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PoolD1 = averagePooling2dLayer([2 2],'Stride',[2 2],'Name','PoolD1');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PoolD2 = averagePooling2dLayer([2 2],'Stride',[2 2],'Name','PoolD2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PoolD3 = averagePooling2dLayer([2 2],'Stride',[2 2],'Name','PoolD3');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
