...
tanh1D1 = tanhLayer('Name','tanh1D1');
tanh2D1 = tanhLayer('Name','tanh2D1');
tanh3D1 = tanhLayer('Name','tanh3D1');
tanh4D1 = tanhLayer('Name','tanh4D1');
CatD1 = concatenationLayer(3,5,'Name','CatD1');
Conv2 = convolution2dLayer([5,5],200,'Name','Conv2');  % 50, 100, 200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PoolMaxD1 = maxPooling2dLayer([2,2],'Stride',[2,2],'Name','PoolMaxD1');
PoolMaxD2 = maxPooling2dLayer([2,2],'Stride',[2,2],'Name','PoolMaxD2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
tanh1D2 = tanhLayer('Name','tanh1D2');
tanh2D2 = tanhLayer('Name','tanh2D2');
tanh3D2 = tanhLayer('Name','tanh3D2');
tanh4D2 = tanhLayer('Name','tanh4D2');
CatD2 = concatenationLayer(3,5,'Name','CatD2');
Batch2 = batchNormalizationLayer('Name','Batch2');
Conv3 = convolution2dLayer([4,4],1000,'Name','Conv3'); % 500, 800, 1000
Relu1 = tanhLayer('Name','Relu1');
...
netM0 = addLayers(netM0,tanh1D1);
netM0 = addLayers(netM0,tanh2D1);
netM0 = addLayers(netM0,tanh3D1);
netM0 = addLayers(netM0,tanh4D1);
...
netM0 = addLayers(netM0,tanh1D2);
netM0 = addLayers(netM0,tanh2D2);
netM0 = addLayers(netM0,tanh3D2);
netM0 = addLayers(netM0,tanh4D2);
netM0 = addLayers(netM0,CatD2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = addLayers(netM0,PoolMaxD1);
netM0 = addLayers(netM0,PoolMaxD2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
netM0 = connectLayers(netM0,'Batch1D1','tanh1D1');
netM0 = connectLayers(netM0,'tanh1D1','CatD1/in1');
%netM0 = connectLayers(netM0,'Batch1D1','CatD1/in1');
netM0 = connectLayers(netM0,'Sub2D1','Batch2D1'); % LH
netM0 = connectLayers(netM0,'Batch2D1','tanh2D1');
netM0 = connectLayers(netM0,'tanh2D1','CatD1/in2');
%netM0 = connectLayers(netM0,'Batch2D1','CatD1/in2');
netM0 = connectLayers(netM0,'Add3D1','Batch3D1'); % HL
netM0 = connectLayers(netM0,'Batch3D1','tanh3D1');
netM0 = connectLayers(netM0,'tanh3D1','CatD1/in3');
%netM0 = connectLayers(netM0,'Batch3D1','CatD1/in3');
netM0 = connectLayers(netM0,'Sub3D1','Batch4D1'); % HH
netM0 = connectLayers(netM0,'Batch4D1','tanh4D1');
netM0 = connectLayers(netM0,'tanh4D1','CatD1/in4');
%netM0 = connectLayers(netM0,'Batch4D1','CatD1/in4');
netM0 = connectLayers(netM0,'CatD1','Conv2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Batch1','PoolMaxD1');
netM0 = connectLayers(netM0,'PoolMaxD1','CatD1/in5'); % LL
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
netM0 = connectLayers(netM0,'Batch1D2','tanh1D2');
netM0 = connectLayers(netM0,'tanh1D2','CatD2/in1');
%netM0 = connectLayers(netM0,'Batch1D2','CatD2/in1');
netM0 = connectLayers(netM0,'Sub2D2','Batch2D2'); % LH
netM0 = connectLayers(netM0,'Batch2D2','tanh2D2');
netM0 = connectLayers(netM0,'tanh2D2','CatD2/in2');
%netM0 = connectLayers(netM0,'Batch2D2','CatD2/in2');
netM0 = connectLayers(netM0,'Add3D2','Batch3D2'); % HL
netM0 = connectLayers(netM0,'Batch3D2','tanh3D2');
netM0 = connectLayers(netM0,'tanh3D2','CatD2/in3');
%netM0 = connectLayers(netM0,'Batch3D2','CatD2/in3');
netM0 = connectLayers(netM0,'Sub3D2','Batch4D2'); % HH
netM0 = connectLayers(netM0,'Batch4D2','tanh4D2');
netM0 = connectLayers(netM0,'tanh4D2','CatD2/in4');
%netM0 = connectLayers(netM0,'Batch4D2','CatD2/in4');
netM0 = connectLayers(netM0,'CatD2','Batch2');
%%%%%%%%%%%%%%%%%%%%%%%%%%%
netM0 = connectLayers(netM0,'Conv2','PoolMaxD2');
netM0 = connectLayers(netM0,'PoolMaxD2','CatD2/in5'); % LL
%%%%%%%%%%%%%%%%%%%%%%%%%%%
